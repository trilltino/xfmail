-- XFChat Comprehensive database schema migration
...
COMMENT ON TABLE users IS 'Core user accounts and authentication for XFChat';
COMMENT ON TABLE conversations IS 'Conversation groupings and metadata for XFChat';
COMMENT ON TABLE conversation_participants IS 'Track which users are in which conversations in XFChat';
COMMENT ON TABLE chat_messages IS 'Messages with full Braid CRDT support for synchronization in XFChat';
COMMENT ON TABLE friend_requests IS 'Friend request workflow management for XFChat';
COMMENT ON TABLE contacts IS 'User contact list and presence information for XFChat';
COMMENT ON TABLE usage_tracking IS 'Track user activity and usage metrics for XFChat';
COMMENT ON TABLE messages IS 'Legacy message storage (deprecated, kept for compatibility in XFChat)';
COMMENT ON TABLE version_history IS 'Legacy version tracking (deprecated, kept for compatibility in XFChat)';